...
setTimeout(() => {
   ...
   menu.style.left = "80%";
   menu.innerHTML = "<button id='run'>Run</button><br><br><input type='number' id='rate' min='8' max='20'></input><br><h4>Rate Of Spam (1 is fast, 5 is medium, more is slower)</h4><br><button id='stop'>Stop Spam</button>";
